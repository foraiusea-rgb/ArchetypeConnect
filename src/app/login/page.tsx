        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-lg p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-gray-200 hover:bg-gray-50 disabled:opacity-50 transition-colors"
            >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-4 text-gray-400">or continue as guest</span>
            </div>
          </div>
          ...
          <form onSubmit={handleGuest} className="space-y-3">
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 outline-none transition-all text-gray-900 text-sm"
