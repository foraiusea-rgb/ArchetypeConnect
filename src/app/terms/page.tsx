    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">4. Quiz Results</h2>
            <p>The archetype quiz is designed to be reflective and useful, not clinically diagnostic. Results should not be used as a substitute for professional psychological assessment. See our <a href="/methodology" className="text-indigo-600 hover:underline">Methodology</a> page for more details on limitations.</p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">6. Content</h2>
