  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2 font-display">Terms of Service</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-12">Last updated: March 13, 2026</p>

        <div className="space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">1. Acceptance</h2>
            <p>By using ArchetypeConnect, you agree to these terms. If you don&apos;t agree, please don&apos;t use the platform.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">2. The Service</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">3. Accounts</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">4. Quiz Results</h2>
            <p>The archetype quiz is designed to be reflective and useful, not clinically diagnostic. Results should not be used as a substitute for professional psychological assessment. See our <a href="/methodology" className="text-indigo-600 dark:text-indigo-400 hover:underline">Methodology</a> page for more details on limitations.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">5. User Conduct</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">6. Content</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">7. Availability</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">9. Changes</h2>
