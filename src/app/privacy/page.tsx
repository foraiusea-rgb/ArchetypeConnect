  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2 font-display">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed">
          <section>
            ...
            <p><strong className="text-gray-800 dark:text-gray-100">Account Information:</strong> When you sign in with GitHub or Google, we receive your name, email address, and profile picture from the OAuth provider. Guest accounts only store an optional display name.</p>
            <p className="mt-3"><strong className="text-gray-800 dark:text-gray-100">Quiz Data:</strong> Your quiz answers and resulting archetype scores are stored to generate your identity and enable community features.</p>
            <p className="mt-3"><strong className="text-gray-800 dark:text-gray-100">Usage Data:</strong> We collect standard server logs (IP address, browser type, pages visited) for security and performance purposes.</p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">3. What We Share</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">4. Data Storage &amp; Security</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">6. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">7. Children</h2>
            <p>ArchetypeConnect is not intended for users under 13 years of age. We do not knowingly collect data from children.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">8. Changes</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">9. Contact</h2>
