    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12 text-gray-600 dark:text-gray-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">The 12 Archetypes</h2>
            <p>
            ...
            <p className="mt-4">
              Each archetype represents a <strong className="text-gray-800 dark:text-gray-100">dominant creative approach</strong> &mdash; not a personality type. You are not &ldquo;a Builder&rdquo; or &ldquo;a Storyteller&rdquo; exclusively. You have varying degrees of all 12 archetypes. The quiz measures your relative affinities.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">How Scoring Works</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">The Archetype Chord</h2>
            <p>
              Your results aren&apos;t reduced to a single label. Instead, you receive a three-part <strong className="text-gray-800 dark:text-gray-100">Archetype Chord</strong>:
            </p>
            <ul className="mt-4 space-y-3">
              <li>
                <strong className="text-gray-800 dark:text-gray-100">Core (highest score):</strong> Your dominant creative approach. The mode you default to when working at your best.
              </li>
              <li>
                <strong className="text-gray-800 dark:text-gray-100">Balance (second-highest):</strong> Your complementary strength. This adds nuance and range to your creative practice.
              </li>
              <li>
                <strong className="text-gray-800 dark:text-gray-100">Inverse (lowest score):</strong> Your creative blind spot. This is the archetype you least identify with, and knowing it helps you identify where collaborators can fill gaps.
              </li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Identity Generation</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Matching &amp; Groups</h2>
            <p>
            ...
            <p className="mt-4">
              The matching system uses <strong className="text-gray-800 dark:text-gray-100">cosine similarity</strong> on full score vectors (all 12 scores) to find compatible creators. This means matching considers your entire archetype profile, not just your Core.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Limitations &amp; Transparency</h2>
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 p-6 mt-4 space-y-4">
              <p>
                <strong className="text-gray-800 dark:text-gray-100">This is not a validated psychometric instrument.</strong> The archetype system is designed to be useful and reflective, not clinically diagnostic. It has not been through peer-reviewed validation studies.
              </p>
              <p>
                <strong className="text-gray-800 dark:text-gray-100">12 questions is intentionally short.</strong> We prioritize completion rate over precision. A 60-question assessment would be more accurate but would see significant abandonment. We chose accessibility.
              </p>
              <p>
                <strong className="text-gray-800 dark:text-gray-100">Results are relative, not absolute.</strong> Your scores reflect your relative preferences among the 12 archetypes, not an objective measure of ability in any domain.
              </p>
              <p>
                <strong className="text-gray-800 dark:text-gray-100">Archetypes can shift.</strong> Creative style evolves over time with experience, role changes, and personal growth. The quiz captures where you are now, not who you are forever.
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Influences</h2>
            <p>
